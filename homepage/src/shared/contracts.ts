...
export const IndoorEntityAliasSchema = z.enum([
  ...
  'coway_living_room.aqi', 'coway_living_room.pm25', 'coway_living_room.pm10', 'coway_living_room.filter_life', 'coway_living_room.pre_filter_life', 'coway_living_room.hepa_filter_life', 'coway_living_room.power', 'coway_living_room.speed', 'coway_living_room.preset', 'coway_living_room.timer', 'coway_living_room.light', 'coway_living_room.button_lock', 'coway_living_room.sensitivity',
  'coway_bedroom.aqi', 'coway_bedroom.pm25', 'coway_bedroom.pm10', 'coway_bedroom.filter_life', 'coway_bedroom.pre_filter_life', 'coway_bedroom.hepa_filter_life', 'coway_bedroom.power', 'coway_bedroom.speed', 'coway_bedroom.preset', 'coway_bedroom.timer', 'coway_bedroom.light', 'coway_bedroom.button_lock', 'coway_bedroom.sensitivity',
]);
...
export const PurifierStateSchema = z.object({
  ...
  readings: z.object({ aqi: IndoorReadingSchema, pm25: IndoorReadingSchema, pm10: IndoorReadingSchema, filterLife: IndoorReadingSchema, preFilterLife: IndoorReadingSchema, hepaFilterLife: IndoorReadingSchema }).strict(),
  capabilities: z.object({
