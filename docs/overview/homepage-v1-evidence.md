...
| <a id="okd-telemetry"></a>Direct OKD telemetry and least-privilege identity | Confirmed in production on 2026-08-15 | [schema v5 OKD adapter tests](../../homepage/src/server/okd.test.ts), [OKD RBAC](../../kubernetes/clusters/okd/observability/homepage/rbac.yaml), [preview/production split](../../kubernetes/apps/homepage-custom-preview/kustomization.yaml), and [preflight, soak, and production promotion evidence](../operations/homepage-observability.md#okd-direct-telemetry-rollout) |
