...
| <a id="okd-telemetry"></a>Direct OKD telemetry and least-privilege identity | Preflight confirmed; preview soak pending | [schema v5 OKD adapter tests](../../homepage/src/server/okd.test.ts), [OKD RBAC](../../kubernetes/clusters/okd/observability/homepage/rbac.yaml), [preview/production split](../../kubernetes/apps/homepage-custom-preview/kustomization.yaml), and [30-minute preflight record plus 24-hour soak](../operations/homepage-observability.md#okd-direct-telemetry-rollout) |
