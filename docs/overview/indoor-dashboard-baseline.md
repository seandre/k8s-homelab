...
| IE-014 Backup, restore, rollout | READY | IE-004, IE-009, IE-013 complete | Seven encrypted local archives and PBS copy policy operate; clean-PVC restore and failure matrix pass; preview soak is clean; production and rollback are GitOps-proven. |
