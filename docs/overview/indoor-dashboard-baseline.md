...
| IE-010 Prometheus history | **IMPLEMENTED; CREDENTIAL/LIVE GATE PENDING** | IE-006, IE-007, IE-008 complete; dedicated non-admin token gate remains | Authenticated scrape exports only the 15 normalized indoor readings; fixed 1h/24h/7d/30d queries and unavailable-series behavior are implemented and locally validated. |
