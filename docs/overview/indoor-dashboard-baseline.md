...
| IE-011 Homepage read contract | **IMPLEMENTED; LIVE ROLLOUT PENDING** | IE-001, IE-006, IE-007, IE-008, IE-010 | Schema v3, fixed-alias HA adapter, four indoor history windows, redaction, and healthy/partial/stale/unavailable/unsupported fixtures pass tests; immutable image publication and live preview verification remain. |
