...
| IE-005 AtomS3 Lite proxy | **LIVE; HA/POWER-CYCLE CHECKS PENDING** | IE-004 plus owner USB flash/secrets gate | Exact Kubernetes and UniFi paths, node/unrelated-host tests, protected OTA, and encrypted API handshake pass; HA integration and physical power-cycle reconnection remain. |
