...
| IE-013 Indoor dashboard UI | READY | IE-011 and IE-012 complete | Overview, `/indoor`, four graph windows, capability rendering, review dialogs, truthful pending/failure states, accessibility, responsive, keyboard, and Playwright tests pass. |
