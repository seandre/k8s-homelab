...
| IE-008 Coway live onboarding | **PREPARED; OWNER CREDENTIAL GATE PENDING** | IE-002 and IE-004 complete; owner credential gate | Fixed two-device contract, fail-closed fixture, redaction tests, and independent live-test runbook pass; IoCare onboarding and physical capability checks remain. |
