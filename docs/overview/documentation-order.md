...
9. [Women’s Road Calendar Runbook](../operations/womens-road-calendar.md) covers local and trusted-LAN preview, dataset maintenance, final production verification, private DNS and TLS, GitOps smoke checks, troubleshooting, and immutable-image rollback.
